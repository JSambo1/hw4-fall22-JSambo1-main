...
class Student:
    ...
    def order_food(self, food_list):
        ...
        for item in food_list:
            food_lis_price.append(item.price)
        if sum(food_lis_price) > self.blue_bucks:
            ...
            if self.location == None:
                ...
                if self.location.fill_order(food_list) == True:
                    self.blue_bucks = self.blue_bucks - sum(food_lis_price)
                    return True
                else:
                    return False
